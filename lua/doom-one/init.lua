...
doom_one.set_colorscheme = function()
  ...
  set_hl("CursorLine", { bg = palette.bg })
  ...
  if config.ui.enable_treesitter then
    ...
    set_hl("@attribute.builtin", { link = "Attribute" })
    ...
    set_hl("@comment.error", { fg = palette.red, bold = true })
    set_hl("@comment", { link = "Comment" })
    set_hl("@comment.note", { fg = palette.blue, bold = true })
    set_hl("@comment.todo", { fg = palette.yellow, bold = true })
    set_hl("@comment.warning", { fg = palette.yellow, bold = true })
    ...
    set_hl("@diff.delta", { link = "DiffModifiedGutter" })
    set_hl("@diff.minus", { link = "DiffRemovedGutter" })
    set_hl("@diff.plus", { link = "DiffAddedGutter" })
    ...
    set_hl("@function.method.call", { link = "Method" })
    ...
    set_hl("@keyword.debug", { fg = palette.orange })
    ...
    set_hl("@keyword.modifier", { link = "StorageClass" })
    set_hl("@keyword.operator", { link = "Operator" })
    set_hl("@keyword.repeat", { link = "Repeat" })
    set_hl("@keyword.return", { link = "Keyword" })
    set_hl("@keyword.type", { link = "Structure" })
    set_hl("@label", { link = "Label" })
    set_hl("@markup.heading.1", { link = "rainbow1" })
    set_hl("@markup.heading.2", { link = "rainbow2" })
    set_hl("@markup.heading.3", { link = "rainbow3" })
    set_hl("@markup.heading.4", { link = "rainbow4" })
    set_hl("@markup.heading.5", { link = "rainbow5" })
    set_hl("@markup.heading.6", { link = "rainbow6" })
    set_hl("@markup.heading", { link = "rainbow1" })
    ...
    set_hl("@string.regexp", { link = "Regexp" })
    set_hl("@string.special", { link = "Special" })
    set_hl("@string.special.path", { link = "Directory" })
  ...
  if config.plugins.blink then
    ...
    set_hl("BlinkCmpKindText", { link = "TextNormal" })
    set_hl("BlinkCmpKindMethod", { link = "Method" })
    set_hl("BlinkCmpKindFunction", { link = "Function" })
    set_hl("BlinkCmpKindConstructor", { link = "Constructor" })
    set_hl("BlinkCmpKindField", { link = "Field" })
    set_hl("BlinkCmpKindVariable", { link = "Variable" })
    set_hl("BlinkCmpKindClass", { link = "Class" })
    set_hl("BlinkCmpKindInterface", { fg = palette.yellow })
    set_hl("BlinkCmpKindModule", { fg = palette.blue })
    set_hl("BlinkCmpKindProperty", { link = "Property" })
    set_hl("BlinkCmpKindUnit", { fg = palette.green })
    set_hl("BlinkCmpKindValue", { fg = palette.peach })
    set_hl("BlinkCmpKindEnum", { link = "Enum" })
    set_hl("BlinkCmpKindKeyword", { link = "Keyword" })
    set_hl("BlinkCmpKindSnippet", { fg = palette.magenta })
    set_hl("BlinkCmpKindColor", { fg = palette.red })
    set_hl("BlinkCmpKindFile", { link = "File" })
    set_hl("BlinkCmpKindReference", { fg = palette.red })
    set_hl("BlinkCmpKindFolder", { fg = palette.blue })
    set_hl("BlinkCmpKindEnumMember", { fg = palette.teal })
    set_hl("BlinkCmpKindConstant", { link = "Constant" })
    set_hl("BlinkCmpKindStruct", { link = "Structure" })
    set_hl("BlinkCmpKindEvent", { fg = palette.blue })
    set_hl("BlinkCmpKindOperator", { link = "Operator" })
    set_hl("BlinkCmpKindTypeParameter", { fg = palette.violet })
    set_hl("BlinkCmpKindCopilot", { fg = palette.teal })
  end
